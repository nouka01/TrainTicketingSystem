...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 08, 2022 at 03:18 PM
...
INSERT INTO `users` (`id`, `user_name`, `user_email`, `user_password`, `user_phone`, `user_type`) VALUES
(1, 'Magdy', 'youssef@magdy.com', 'password', 1140523092, 'Admin'),
(2, 'asd', 'asd', 'asd', 0, 'Admin'),
(3, 'asd', 'asd', 'asd', 0, ''),
